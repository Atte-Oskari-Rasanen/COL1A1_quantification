...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 16 00:46:01 2021
...
For the residual U-net:
https://www.kaggle.com/firqaaa/residual-unet-keras-implementation
"""
...
def Attention_UNet(input_shape, NUM_CLASSES=1, dropout_rate=0, batch_norm=True):
    '''
    Attention UNet, 
    
    '''
    dropout_rate=str(dropout_rate).lower() #had to add this, otherwise gives an attribute error
    # network structure
