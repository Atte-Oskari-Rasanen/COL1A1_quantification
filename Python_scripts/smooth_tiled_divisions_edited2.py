...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 15 18:22:03 2021
...
"""
Source: https://github.com/bnsreenu/python_for_microscopists/blob/master/229_smooth_predictions_by_blending_patches/smooth_tiled_predictions.py
...
def _windowed_subdivs(padded_img, window_size, subdivisions, nb_classes, pred_func):
    ...
    print('subdivs shape: ' + str(subdivs.shape))
    # subdivs = subdivs.reshape(a ,b, c, d, e)
    
    #modify b dimension: 
    # b = round(b/3) * 2
    subdivs = subdivs.reshape(a * b, c, d, e)
    print('subdivs shape after a*b: ' + str(subdivs.shape))

    gc.collect()

    subdivs = pred_func(subdivs)
    print('subdivs shape after prediction: '+ str(subdivs.shape))
    gc.collect()
    ...
    print('subdivs shape after prediction and reshaping: '+ str(subdivs.shape))
