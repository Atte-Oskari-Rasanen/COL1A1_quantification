...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 15:43:56 2021
...
import numpy as np
a = np.random.randint(0,1, size=(40,5,5,3))

# b = np.zeros((1,5,5,3))

# ab_list = list(a)
# ab_list.append(b)
# a = np.concatenate(ab_list, axis = 0)
# for i in range(a.shape[0] - 1):
#     current_arr = a[i]
#     if np.all(current_arr==0):
...
def import_images(TRAIN_PATH, IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS):
    ...
    for im in image_names:
        ...
        # img_patches.astype('float32')
        #the patches should all be the appointed size but resizing just in case:
        # img_patches = resize(img_patches, (IMG_HEIGHT, IMG_WIDTH), mode='constant', preserve_range=True)
